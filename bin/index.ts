...
// import { printDirectoryTree } from '../src/tree';
// import { createDirectoryTreeJSON } from '../src/backup';
// import { categorizeAndMoveFiles } from '../src/restructFolderStructure';
...
//   .option('-ext, --extension <extension>', 'Add extensions which you want to restructure sample input: -ext jpg,png,pdf')
//   .action((cmd) => {
//     if (cmd.path === undefined || cmd.path === null || cmd.path === '') {
